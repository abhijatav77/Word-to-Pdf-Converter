...
const Home = () => {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            ...
            link.href = url;
            link.setAttribute("download", setSelectedFile.name.replace(/\.[^/.]+$/,"")+".pdf")
        ...
        <div className='max-w-screen-2xl mx-auto container px-6 py-3 md:px-40'>
            <div className='flex h-screen items-center justify-center'>
                <div className='border-2 border-dashed px-4 py-2 md:px-8 md:py-6 border-indigo-400 rounded-lg shadow-lg'>
                    <h1 className='text-3xl font-bold text-center mb-4'>Conver WORD to PDF Online</h1>
                    <p className='text-sm text-center mb-5'>Easily convert word documents to pdf formate online, without having to install any software.</p>
                    ...
                    <div className='flex flex-col items-center space-y-4'>
                        ...
                        <button onClick={handleSubmit} className={`text-white duration-300 font-bold px-4 py-2 rounded cursor-pointer ${!selectedFile ? "bg-blue-300" : "bg-blue-500 hover:bg-blue-700"}`}>Convert File</button>
                        {convert && (
